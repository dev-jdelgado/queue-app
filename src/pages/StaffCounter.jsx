    ...
    return (
      <div className="min-h-screen bg-gray-50 text-gray-900 flex items-center justify-center p-6">
        <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm max-w-md w-full">
          <p className="text-lg font-semibold">Invalid counter</p>
          <p className="mt-1 text-sm text-gray-600">Go back and select a counter.</p>
    ...
    <div className="min-h-screen bg-gray-50 text-gray-900">
      <div className="mx-auto max-w-xl px-3 sm:px-6 py-10">
        <div className="flex items-end justify-between gap-3">
          <div>
            <Link to="/staff" className="text-sm font-semibold text-emerald-700 hover:text-emerald-800">
              ← Staff Home
            </Link>
        ...
        <div className="mt-6 rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
          ...
          <p className="mt-2 text-6xl font-semibold tabular-nums">{pad(nowServing)}</p>

          <p className="mt-4 text-xs font-semibold tracking-widest text-gray-500">NEXT TICKET</p>
          <p className="mt-2 text-4xl font-semibold tabular-nums">{pad(state.nextTicket)}</p>
